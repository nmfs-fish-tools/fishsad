#' Age-Structured Stock Assessment Model Comparison (ASSAMC) Project input and output data based on a simulated hypothetical population - Ricker model case.
#'
#' A dataset containing the operating model input and output based on information available for actual stocks from the snapper-grouper complex that have been individually assessed in the Atlantic waters off the southeastern US. It uses Ricker spawner-recruit model.
#'
